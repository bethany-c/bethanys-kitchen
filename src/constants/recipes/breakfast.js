export const breakfast = {
  'Omelette': {
    title: 'Omelette',
    subtitle: 'Easy ham and cheese omelette',
  ...
  'Avocado Bagel': {
    title: 'Avocado Bagel',
    subtitle: 'A brunch staple',
    description: 'This is a quick bagel I love to eat on the way to work. If I am eating this at home, I usually fry an egg as well but that is optional. My favourite type of bagel is the everything but the bagel flavour, but if you do not have that flavour, you can substitute for everything but the bagel seasoning.',
    ingredients: [
      '1 avocado', 
      'Butter', 
      '1 bagel', 
  ...
  'Scrambled Eggs': {
    ...
    subtitle: 'Soft cloud like scrambled eggs',
  ...
  'Yogurt Bowl': {
    title: 'Yogurt Bowl',
    subtitle: 'Quick Greek yogurt bowl packed with fruits',
